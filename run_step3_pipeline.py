...
def main():
    ...
    # Nếu file chưa tồn tại thì tạo mới, nếu có thì vẫn append header mới vào cuối
    with open(OUTPUT_FILE_PATH, 'a', encoding='utf-8') as f:
        f.write("### TASK QA\n")
        f.write("num_correct,answers\n")
        print(f"Đã ghi header (hoặc append thêm) vào file output tại '{OUTPUT_FILE_PATH}'.")
